...
import asromasfrom from "@/assets/asromas.png";
import tick_circle from "@/assets/tick-circle.png";
import vikki_user_icon from "@/assets/vikki_user_icon.png";
import star from "@/assets/star.png";
import star_no_color from "@/assets/star_no_color.png";
import copy from "@/assets/copy.png";
import fb_icon from "@/assets/fb_icon.png";
import twitter_icon from "@/assets/twitter_icon.png";
 import hotline_icon from "@/assets/hotline_icon.png";
    ...
    return (
        ...
        <div className="flex flex-col lg:gap-y-5">
          <div className="lg:h-[211px] flex flex-col lg:gap-y-4">
            ...
            <strong
              className="lg:text-[32px] lg:mt-[1px] mb:mt-3.5 mb:text-[20px] lg:tracking-[-1.2px] font-medium lg:leading-[38.4px]">Mix
            ...
            <div className="flex lg:items-center mb:items-end justify-between">
              <span className="font-medium text-[#EB2606] lg:text-xl lg:tracking-[0.7px] mb:text-base flex items-center lg:gap-x-3 lg:mt-0.5 mb:gap-x-2"><del
                  className="font-light lg:text-sm mb:text-sm text-[#9D9EA2]">$200.00</del>$120.00</span>
              <section
                className="lg:w-[163px] mb:w-[157px] mb:mt-[8px] lg:mt-0 h-[21px] *:lg:text-sm *:mb:text-xs flex justify-between items-start">
          ...
          <div className="lg:h-[251px] border rounded-xl lg:px-6 lg:py-5 mb:px-5 mb:py-[20px] lg:my-0 mb:my-[18px]">
            <div className="w-full h-full flex flex-col gap-y-5">
              <section className="flex gap-x-4">
                <img className="w-8 h-8" src={colorfilter} alt=""/>
              ...
              <section className="flex gap-x-4">
                <img className="w-8 h-8" src={relieve} alt=""/>
              ...
              <section className="flex gap-x-4 lg:translate-y-1">
                <img className="w-8 h-8" src={asromasfrom} alt=""/>
          ...
          <div className="flex flex-col lg:gap-y-[22px] border-t lg:mt-[5px] lg:py-5 mb:py-6">
            <div className="grid lg:grid-cols-[48.5%_48.5%] justify-between items-start">
              <div className="*:text-xs flex flex-col gap-y-3 lg:mt-0 mb:-mt-1">
                ...
                <section className="*:lg:px-[13.5px] *:lg:py-2.5 *:mb:px-3.5 *:mb:py-2 *:rounded flex gap-x-4 *:duration-200">
                  ...
                  <button
                    className="hover:border-[#17AF26] border bg-[#F4F4F4] hover:bg-[#F3FBF4] border-[#F3FBF4]">1/2lb</button>
                  <button
                    className="hover:border-[#17AF26] border bg-[#F4F4F4] hover:bg-[#F3FBF4] border-[#F3FBF4]">1/4lb</button>
                </section>
              </div>
            ...
            <section
              className="bg-[#FEF8E8] lg:tracking-0 tracking-[0.0002px] px-3.5 py-2 rounded-[100px] lg:w-[342px] lg:mt-0 mb:mt-[18px] mb:w-full text-sm">
          ...
          <div className="grid lg:grid-cols-[49%_49%] justify-between lg:gap-y-0 mb:gap-y-4 lg:text-sm mb:text-xs *:flex border-t lg:pt-6 lg:mt-0 mb:pt-[18px] mb:mt-5 mb:grid-cols-full">
            ...
            <span className="font-light text-[#717378] lg:gap-x-[50px] mb:gap-x-10">Categories <p
                className="text-[#17AF26] font-normal">:&#160;&#160;&#160;&#160; AAAA Weed, Indica
              </p></span>
          </div>
        </div>
        ...
        <div className="flex flex-col border-t lg:py-10 lg:mt-10 mb:py-[34px] mb:mt-8">
          <ul className="flex items-center justify-between border-b lg:pb-6 mb:pb-5 *:lg:w-[197.33px] *:mb:w-[106px] *:lg:py-2.5 *:mb:py-[7px] *:rounded-[100px] *:border *:place-items-center *:lg:text-base *:mb:text-xs">
            <button
              className="btn_show_description grid hover:border-[#05422C] border-[#05422C] text-[#05422C] hover:bg-[#F2F6F4] bg-[#F2F6F4]">Description</button>
            <button
              className="btn_show_review flex items-center justify-center gap-x-1 hover:border-[#05422C] hover:text-[#05422C] hover:bg-[#F2F6F4]">Reviews
              <p>(350)</p>
            </button>
            ...
            <div className="flex flex-col text-sm text-[#46494F] leading-[21px] gap-y-4 lg:pt-6 mb:pt-5 mb:pb-0">
              <div className="border rounded-2xl lg:p-6 mb:p-5">
                <div className="flex items-center *:flex *:items-center gap-x-4 border-b border-[#F4F4F4] pb-4 mb-4">
                  <img width="36" height="36" src={vikki_user_icon} alt=""/>
                  <strong className="text-base text-[#1A1E26] font-medium gap-x-4">Vikki Starr <span
                      className="text-sm text-[#9D9EA2] font-light">|</span> <span
                      className="text-sm text-[#9D9EA2] font-light">January 15, 2023</span></strong>
                </div>
              ...
              <div className="border rounded-2xl lg:p-6 mb:p-5">
                <div className="flex items-center *:flex *:items-center gap-x-4 border-b border-[#F4F4F4] pb-4 mb-4">
                  <img width="36" height="36" src={vikki_user_icon} alt=""/>
                  <strong className="text-base text-[#1A1E26] font-medium gap-x-4">Terry Baskey <span
                      className="text-sm text-[#9D9EA2] font-light">|</span> <span
                      className="text-sm text-[#9D9EA2] font-light">January 15, 2023</span></strong>
                </div>
                <section className="flex flex-col gap-y-4">
              ...
              <div className="flex justify-center my-1">
                <button
                  className="px-5 py-2 text-[#17AF26] text-sm rounded-[100px] border hover:bg-[#F9F9F9] cursor-pointer duration-300">Show
                  More</button>
              </div>
              <div className="flex flex-col gap-y-6 border-t lg:pt-7 lg:pb-[22px]">
                ...
                <form className="-mt-1.5">
                  ...
                  <div
                    className="overflow-hidden lg:p-4 rounded-lg border border-gray-200 shadow-sm focus-within:border-none focus-within:ring-1 focus-within:none mt-2">
            ...
            <div className="rounded-2xl lg:px-6 lg:pt-7 lg:pb-4 mb:p-5 border flex flex-col gap-y-5 mt-5 mb-[23px]">
              ...
              <section className="*:p-4 mt-1 *:bg-[#F3FBF4] flex flex-col gap-y-6 *:rounded-xl border-b pb-6">
                <div className="flex item-center justify-between gap-x-3">
                  <div className="w-0.5 bg-[#EB2606]"></div>
                  ...
                  <div className="w-10 h-10 rounded-[50%] bg-white grid place-items-center">
                    <img width="18" height="18" src={copy} alt=""/>
                  </div>
                </div>
                <div className="flex item-center justify-between gap-x-3">
                  <div className="w-0.5 bg-[#EB2606]"></div>
              ...
              <nav
                className="flex lg:flex-row mb:flex-col mt-1 *:lg:px-5 *:lg:py-4 *:gap-y-4 *:border *:rounded-[14px] justify-between lg:gap-x-6 *:grid *:place-items-center">
                <div>
              ...
              <form>
                <div className="grid mt-1 lg:grid-cols-[42%_42%_auto] items-end justify-between gap-y-4">
                  ...
                  <button
                    className="bg-[#F3FBF4] rounded-[50%] w-12 h-12 hover:scale-105 duration-300 cursor-pointer text-[#17AF26] text-3xl font-light grid place-items-center">
                    <img src={add} alt=""/>
                  </button>
                  <div className="flex flex-col items-start gap-y-2">
