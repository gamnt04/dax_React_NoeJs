        ...
        <div className="lg:block hidden py-3 mt-0.5">
                ...
                <section className="flex flex-col pt-[47px] pb-6">
                    ...
                    <ul className="*:gap-y-3 *:gap-x-3.5 *:tracking-[1px] pt-2.5 pb-1.5 *:flex *:items-center *:my-[9px] border-b">
                        <li className=""><input id="sale1" className="w-5 h-5 invisible" type="radio"/>
                            <label className="relative sale2 before:w-5 before:h-5 before:border active:before:border-[6px] before:top-[10%] before:left-[-90%] active:before:border-[#17AF26] before:rounded-[50%] before:absolute">Sale</label>
                            <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
                        </li>
                        <li><input id="sale" className="w-[20px] h-[20px] accent-[#17AF26]" type="radio"/><label >Sale</label>
                            <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
                        </li>
                        <li><input id="sale" className="w-[20px] h-[20px] accent-[#17AF26]" type="radio"/><label >Sale</label>
                            <span className="text-[#9D9EA2] font-light ml-[7px]">12</span>
