...
import mastercard_v1 from "@/assets/mastercard_v1.png"
import mastercard_v2 from "@/assets/mastercard_v2.png"
import mastercard_v3 from "@/assets/mastercard_v3.png"
import mastercard_v4 from "@/assets/mastercard_v4.png"
const Footer = () => {
    return (
    ...
    <div className="relative lg:pt-[403px] mb:pt-[271px] lg:w-[1200px] mb:w-[342px] mx-auto">
      ...
      <div className="flex lg:flex-row mb:flex-col lg:gap-x-16 lg:gap-y-0 gap-y-8 *:w-full">
        <div className="lg:w-[385px]">
          <img className="w-[173px] h-[42px]" src={logo_white} alt=""/>
