      ...
      <div className="w-full relative flex sm:flex-row mb:flex-col mb:items-center justify-center lg:my-16 mb:my-[22px] mb:overflow-x-auto hidden_scroll_x">
        ...
        lg:w-[1348px] rounded-xl lg:translate-x-[28px]">
            ...
            items-center justify-center gap-y-6">
              <img src={img_product} className="lg:w-[213px] lg:h-[213px] mb:w-[151px] mb:h-[151px]" alt=""/>
              ...
              <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-[32px] h-[568px]">
                <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
                  ...
                  <div className="relative group w-full h-[240px] bg-[#F4F4F4] rounded-xl grid place-items-center">
                    <img className="w-[164px] h-[164px]" src={product_5} alt=""/>
                    <button
                  ...
                  <div className="w-full h-[304px] flex flex-col justify-between items-center">
                    ...
                    <section
                      className="bg-[#F2F6F4] w-[92px] h-[28px] lg:-translate-y-1 text-xs rounded grid place-items-center my-3">
                      Sativa 100%
                    </section>
                    ...
                    <div
                      className="flex *:text-xs *:py-[7px] *:px-[10px] gap-x-2 my-3 *:border *:rounded lg:-translate-y-1.5">
                      <button>28g</button>
                      <button>1/2lb</button>
                      <button>1/4lb</button>
                    </div>
                    <button
                      className="bg-[#17AF26] w-[128px] h-[40px] grid place-items-center rounded-[100px] text-sm text-white">
                      Add to Cart
                    </button>
                  </div>
                </div>
                <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
                  <div className="relative group w-full h-[240px] bg-[#F4F4F4] rounded-xl grid place-items-center">
                    <img className="w-[164px] h-[164px]" src={img_product} alt=""/>
                    <button
                      className="absolute scale-0 group-hover:scale-100 group-hover:translate-y-0 -translate-y-[200%] duration-200 z-[2] lg:w-[152px] mb:w-[136px] lg:h-[64px]  mb:h-[48px] rounded-[100px] border-none bg-[#1A1E2630] text-sm text-white backdrop-blur-md">Out
                      Of Stock</button>
                    <section className="hidden absolute top-0 left-0 bg-[#F2BC1B] px-3 py-1.5 text-white">$60 ounce
        ...
        <div
          className="sm:hidden w-full custome_scroll_x_center_item snap-x mt-8 h-full h-[568px] overflow-x-auto hidden_scroll_x">
          <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-6 h-[568px]">
            <div className="flex snap-center flex-col overflow-hidden gap-y-6 h-full rounded-xl">
              ...
              <div className="w-full h-[304px] flex flex-col justify-between items-center">
                ...
                <section
                  className="bg-[#F2F6F4] w-[92px] -translate-y-1.5 h-[28px] text-xs rounded grid place-items-center my-3">
                  Sativa 100%
                </section>
                ...
                <button
                  className="bg-[#17AF26] w-[118px] h-[40px] grid place-items-center rounded-[100px] text-xs text-white">
                  Add to Cart
                </button>
              </div>
            </div>
