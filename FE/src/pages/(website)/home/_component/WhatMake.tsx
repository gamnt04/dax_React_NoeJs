const WhatMake = () => {
    ...
    <div className="lg:w-[1200px] mb:w-[342px] flex flex-col">
      <div className="lg:w-[789px] flex flex-col">
        <strong
          className="lg:text-[64px] mb:text-[32px] lg:leading-[70px] mb:leading-[38px] lg:tracking-[-4.6px] mb:tracking-[-1.8px]">WHAT
      ...
      <div className="w-full lg:mt-10 mb:mt-4 lg:grid mb:flex mb:flex-col lg:grid-cols-[379px_379px_379px] lg:justify-between lg:gap-y-10 *:mb:mb-6 *:lg:mb-0">
        ...
        <div className="lg:order-none order-3">
          <div
            className="flex flex-col lg:gap-y-8 mb:gap-y-[2.5px] justify-between lg:pt-[32px] lg:px-[32px] lg:pb-[95px] mb:px-4 mb:pb-3.5 rounded-xl border">
        ...
        <div className="lg:order-none order-5">
          <div
            className="flex flex-col lg:gap-y-8 mb:gap-y-[2.5px] justify-between lg:pt-[32px] lg:px-[32px] lg:pb-[95px] mb:px-4 mb:pb-3.5 border rounded-xl">
